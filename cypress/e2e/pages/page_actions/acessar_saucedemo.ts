...
export class OpenSauce {
  ...
  static addProductCart() {
    ...
    static removeProductCart(){
      ...
      cy.get(SauceCartElements.BNT_REMOVE_PRODUCT_1).click()
      cy.get(SauceCartElements.BNT_REMOVE_PRODUCT_2).click()
      cy.get(SauceCartElements.BNT_REMOVE_PRODUCT_3).click()
      cy.get(SauceCartElements.BNT_REMOVE_PRODUCT_4).click()
      cy.get(SauceCartElements.BNT_REMOVE_PRODUCT_5).click()
      cy.get(SauceCartElements.BNT_REMOVE_PRODUCT_6).click()
    ...
    static checkoutOverview(){
      ...
      cy.get(SauceCheckoutElements.CHECK_PRODUCT_1).contains('Sauce Labs Backpack')
      cy.get(SauceCheckoutElements.CHECK_PRODUCT_2).contains('Sauce Labs Bike Light')
      cy.get(SauceCheckoutElements.CHECK_PRODUCT_3).contains('Sauce Labs Bolt T-Shirt')
      cy.get(SauceCheckoutElements.CHECK_PRODUCT_4).contains('Sauce Labs Fleece Jacket')
      cy.get(SauceCheckoutElements.CHECK_PRODUCT_5).contains('Sauce Labs Onesie')
      cy.get(SauceCheckoutElements.CHECK_PRODUCT_6).contains('Test.allTheThings() T-Shirt (Red)')
    
      cy.get(SauceCheckoutElements.CHECK_INFO_PAY).contains('SauceCard')
      cy.get(SauceCheckoutElements.CHECK_INFO_SHIPPING).contains('Free Pony Express Delivery!')
      cy.get(SauceCheckoutElements.CHECK_TOTAL).contains('$140.34')
      
      
      cy.get(SauceCheckoutElements.CHECK_BTN_FINISH).click()

      cy.get(SauceCheckoutElements.MSG_SUCCESS).contains('Thank you for your order!')
      cy.get(SauceCheckoutElements.BTN_BACKHOME).click()
